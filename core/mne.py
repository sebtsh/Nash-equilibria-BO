        ...
        for s1 in all_s1:
            ...
            A2 = np.setdiff1d(
                ...
                conditionally_dominated(
                    p1actions=s1, p2actions=np.arange(M2), active_agent=2, U1=U1, U2=U2
                ),
            )
            if (
                len(
                    conditionally_dominated(
                        p1actions=s1, p2actions=A2, active_agent=1, U1=U1, U2=U2
                    )
                )
                == 0
            ):
                ...
                for s2 in all_s2:
                    ...
                    if (
                        len(
                            conditionally_dominated(
                                p1actions=s1, p2actions=s2, active_agent=1, U1=U1, U2=U2
                            )
                        )
                        == 0
                    ):  # if true, run TGS
